...
Feature: Corporate Banking Fund Transfer
 ...
 # Given I'm on Autobahn Corporate user login page with "valid_username" and "valid_password"
  ...
  Scenario: Validation of Union Bank Account Fund Transfer scenario with entering the recipient account number
    ...
    Then "Fund Transfer" page should be displayed with "Make a Transfer", "Manage Beneficiaries" & "View All Organization Transfers"
    When I click on "Make a Transfer" and Choose "UnionBank Accounts" channel
    And Enter the transfer details with "SourceAccount" & "12DigitUnionBankAccount"
    And Review the transfer details with "12DigitUnionBankAccount" details
    And click Submit
    Then Transaction should be successful
...
#need to add PDDTS and SWIFT into approval hierarchy
  ...
  Scenario Outline: Validation of scheduled fund transfer scenario for various payment channel
    ...
    Examples:
      ...
      | Maker_username | Maker_password | Approval_Organization | UnionBank Accounts | SourceAccount       | 12DigitUnionBankAccount | 11.01          | Daily     | 2023-December-22 |
      | Maker_username | Maker_password | Approval_Organization | UnionBank Accounts | SourceAccount       | DestinationAccount      | 22.01          | ONE-TIME  | 2023-December-22 |
      | Maker_username | Maker_password | Approval_Organization | UnionBank Accounts | SourceAccount       | Beneficiary             | 33.01          | Weekly    | 2023-November-22 |
      | Maker_username | Maker_password | Approval_Organization | PESONet            | SourceAccount       | EnterBeneficiaryDetails | 44.01          | ONE-TIME  | 2023-December-22 |
      | Maker_username | Maker_password | Approval_Organization | PESONet            | SourceAccount       | Beneficiary             | 55.01          | Daily     | 2023-December-22 |
      | Maker_username | Maker_password | Approval_Organization | PDDTS              | PDDTS_SourceAccount | Beneficiary             | 65.01          | ONE-TIME  | 2023-December-22 |
      | Maker_username | Maker_password | Approval_Organization | PDDTS              | PDDTS_SourceAccount | EnterBeneficiaryDetails | 75.01          | Daily     | 2023-December-22 |
      | Maker_username | Maker_password | Approval_Organization | SWIFT              | SWIFT_SourceAccount | Beneficiary             | 85.01          | ONE-TIME  | 2023-December-22 |
      | Maker_username | Maker_password | Approval_Organization | SWIFT              | SWIFT_SourceAccount | EnterBeneficiaryDetails | 95.01          | Daily     | 2023-December-22 |
      | Maker_username | Maker_password | Approval_Organization | instaPay           | SourceAccount       | EnterBeneficiaryDetails | 41.01          | ONE-TIME  | 2023-December-22 |
  ...
  Scenario Outline: Validation of transaction not allowed scenario for scheduled fund transfer with various payment channel
    ...
    Examples:
      | Maker_user     | Maker_pwd      | organization          | channel            | From                | To                      | transferAmount | frequency | date             |
      | Maker_username | Maker_password | Approval_Organization | UnionBank Accounts | SourceAccount       | 12DigitUnionBankAccount | 1110.01        | Daily     | 2023-December-22 |
      | Maker_username | Maker_password | Approval_Organization | UnionBank Accounts | SourceAccount       | DestinationAccount      | 1110.01        | ONE-TIME  | 2023-December-22 |
      | Maker_username | Maker_password | Approval_Organization | UnionBank Accounts | SourceAccount       | Beneficiary             | 1130.01        | Weekly    | 2023-November-22 |
      | Maker_username | Maker_password | Approval_Organization | PESONet            | SourceAccount       | EnterBeneficiaryDetails | 1140.01        | ONE-TIME  | 2023-November-22 |
      | Maker_username | Maker_password | Approval_Organization | PESONet            | SourceAccount       | Beneficiary             | 1150.01        | Daily     | 2023-November-22 |
      | Maker_username | Maker_password | Approval_Organization | PDDTS              | PDDTS_SourceAccount | Beneficiary             | 1160.01        | ONE-TIME  | 2023-December-22 |
      | Maker_username | Maker_password | Approval_Organization | PDDTS              | PDDTS_SourceAccount | EnterBeneficiaryDetails | 1170.01        | Daily     | 2023-December-22 |
      | Maker_username | Maker_password | Approval_Organization | SWIFT              | SWIFT_SourceAccount | Beneficiary             | 1180.01        | ONE-TIME  | 2023-December-22 |
      | Maker_username | Maker_password | Approval_Organization | SWIFT              | SWIFT_SourceAccount | EnterBeneficiaryDetails | 1190.01        | Daily     | 2023-December-22 |
      | Maker_username | Maker_password | Approval_Organization | instaPay           | SourceAccount       | EnterBeneficiaryDetails | 1140.01        | ONE-TIME  | 2023-December-22 |
  ...
  Scenario Outline: Validation of Edit button functionality in fund transfer scenario
    ...
    Examples:
      | Maker_user     | Maker_pwd      | organization          | channel            | From                | To                      | transferAmount | frequency | date             |
      | Maker_username | Maker_password | Approval_Organization | UnionBank Accounts | SourceAccount       | 12DigitUnionBankAccount | 1110.01        | Daily     | 2023-December-22 |
      | Maker_username | Maker_password | Approval_Organization | PESONet            | SourceAccount       | EnterBeneficiaryDetails | 1140.01        | ONE-TIME  | 2023-December-22 |
      | Maker_username | Maker_password | Approval_Organization | PDDTS              | PDDTS_SourceAccount | Beneficiary             | 1160.01        | ONE-TIME  | 2023-December-22 |
      | Maker_username | Maker_password | Approval_Organization | SWIFT              | SWIFT_SourceAccount | Beneficiary             | 1180.01        | ONE-TIME  | 2023-December-22 |
      | Maker_username | Maker_password | Approval_Organization | instaPay           | SourceAccount       | EnterBeneficiaryDetails | 1190.01        | ONE-TIME  | 2023-December-22 |
  ...
  Scenario Outline: Validation of deleting a scheduled fund transfer scenario
    ...
    Examples:
      | Maker_user     | Maker_pwd      | organization          | channel            | From                | To                      | transferAmount | frequency | date             |
      | Maker_username | Maker_password | Approval_Organization | UnionBank Accounts | SourceAccount       | 12DigitUnionBankAccount | 10.01          | Daily     | 2023-December-22 |
      | Maker_username | Maker_password | Approval_Organization | PESONet            | SourceAccount       | EnterBeneficiaryDetails | 40.01          | ONE-TIME  | 2023-December-22 |
      | Maker_username | Maker_password | Approval_Organization | PDDTS              | PDDTS_SourceAccount | Beneficiary             | 60.01          | ONE-TIME  | 2023-December-22 |
    #  | Maker_username | Maker_password | Approval_Organization | SWIFT              | SWIFT_SourceAccount | Beneficiary             | 80.01          | ONE-TIME  | 2023-December-22 |
    #  | Maker_username | Maker_password | Approval_Organization | instaPay           | SourceAccount       | EnterBeneficiaryDetails | 40.01          | ONE-TIME  | 2023-December-22 |
  ...
  Scenario Outline: Validation of Deleting the Transaction created by the Corporate user (Maker) across different scheduled Fund Transfer Transaction falls under Approval Hierarchy Flow
    ...
    Examples:
      ...
      | Maker_username                  | Maker_password                  | Approval_Organization                  | UnionBank Accounts | SourceAccount                     | Beneficiary             | 130.01         | Weekly    | 2023-November-22 | Approval_username                  | Approval_password                  | Approval_username_two                  | Approval_password_two                  |
      | Maker_username                  | Maker_password                  | Approval_Organization                  | PESONet            | SourceAccount                     | Beneficiary             | 150.01         | Daily     | 2023-December-22 | Approval_username                  | Approval_password                  | Approval_username_two                  | Approval_password_two                  |
      | Maker_username                  | Maker_password                  | Approval_Organization                  | PDDTS              | PDDTS_SourceAccount               | Beneficiary             | 160.01         | ONE-TIME  | 2023-December-22 | Approval_username                  | Approval_password                  | Approval_username_two                  | Approval_password_two                  |
      | Maker_username                  | Maker_password                  | Approval_Organization                  | SWIFT              | SWIFT_SourceAccount               | Beneficiary             | 180.01         | ONE-TIME  | 2023-December-22 | Approval_username                  | Approval_password                  | Approval_username_two                  | Approval_password_two                  |
      | AccountValidationMaker_username | AccountValidationMaker_password | AccountValidationApproval_Organization | instaPay           | AccountValidationPHPSourceAccount | EnterBeneficiaryDetails | 140.01         | ONE-TIME  | 2023-December-22 | AccountValidationApproval_username | AccountValidationApproval_password | AccountValidationApproval_username_two | AccountValidationApproval_password_two |
  ...
  Scenario Outline: Validation of scheduled fund transfer scenario with approval flow for various payment channel
    ...
    Examples:
      ...
      | AccountValidationMaker_username | AccountValidationMaker_password | AccountValidationApproval_username | AccountValidationApproval_password | AccountValidationApproval_username_two | AccountValidationApproval_password_two | AccountValidationApproval_Organization | PESONet            | AccountValidationPHPSourceAccount | EnterBeneficiaryDetails | 120.01         | ONE-TIME  | 2023-November-22 |
      | AccountValidationMaker_username | AccountValidationMaker_password | AccountValidationApproval_username | AccountValidationApproval_password | AccountValidationApproval_username_two | AccountValidationApproval_password_two | AccountValidationApproval_Organization | UnionBank Accounts | AccountValidationPHPSourceAccount | 12DigitUnionBankAccount | 150.01         | Weekly    | 2023-November-22 |
     | AccountValidationMaker_username | AccountValidationMaker_password | AccountValidationApproval_username | AccountValidationApproval_password | AccountValidationApproval_username_two | AccountValidationApproval_password_two | AccountValidationApproval_Organization | PDDTS              | AccountValidationUSDSourceAccount | Beneficiary             | 180.01         | ONE-TIME  | 2023-November-22 |
      | AccountValidationMaker_username | AccountValidationMaker_password | AccountValidationApproval_username | AccountValidationApproval_password | AccountValidationApproval_username_two | AccountValidationApproval_password_two | AccountValidationApproval_Organization | SWIFT              | AccountValidationUSDSourceAccount | EnterBeneficiaryDetails | 210.01         | Weekly    | 2023-November-22 |
      | AccountValidationMaker_username | AccountValidationMaker_password | AccountValidationApproval_username | AccountValidationApproval_password | AccountValidationApproval_username_two | AccountValidationApproval_password_two | AccountValidationApproval_Organization | instaPay           | AccountValidationPHPSourceAccount | Beneficiary             | 220.01         | Daily     | 2023-November-22 |
     | AccountValidationMaker_username | AccountValidationMaker_password | AccountValidationApproval_username | AccountValidationApproval_password | AccountValidationApproval_username_two | AccountValidationApproval_password_two | AccountValidationApproval_Organization | UnionBank Accounts | AccountValidationUSDSourceAccount | USDBeneficiary          | 250.01         | Daily     | 2023-November-22 |
  ...
  Scenario: Verify whether user is able to see Scan  icon and request  icon at upper right of Transact page
    Given I'm on Autobahn Corporate user login page with "valid_username","valid_password" & "user_Organization"
    When I click on "TRANSACT" menu option
    Then Verify Request Payment and Scan icon

  Scenario: Verify user is able to see tutorial after clicking on Help button and User can be able to skip the tutorial in Transact
    Given I'm on Autobahn Corporate user login page with "valid_username","valid_password" & "user_Organization"
    When I click on "TRANSACT" menu option
