...
@PaymentTransfer  @release7  @Regression8Sept.1
Feature: Corporate Banking Merchant Creation and Payments
  ...
  Scenario: Payment channels disabled based on Amount in Unique eWallet
    Given I'm on Autobahn Corporate user login page with "Setup_username","Setup_password" & "user_Organization"
    Then Navigate Generic Payment Screen
    Then Validation of Generic eWallet Amount Field


  Scenario: Payment channels disabled based on Amount in Unique OTC
    Given I'm on Autobahn Corporate user login page with "Setup_username","Setup_password" & "user_Organization"
    Then Navigate Generic Payment Screen
  ...
  Scenario: Payment channels disabled based on Amount in Unique eWallet
    ...
    And Click on "Request Payment" option
    And Click on Request Payment on Payments Link Screen
    Then Enter Payment Entry Page Details "50.00","AutoTestPaymentUniqueeWllet","AutoTestNotePaymentUniqueeWllet","1 days","9876326536","generateuniquelink"
    Then Validation of Unique eWallet Amount Field "AutoSME","PHP 50.00","AutoTestPaymentUniqueeWllet"
  ...
  Scenario: Payment channels disabled based on Amount in Unique OTC
    ...
    And Click on "Request Payment" option
    And Click on Request Payment on Payments Link Screen
    Then Enter Payment Entry Page Details "50.00","AutoTestPaymentUniqueOTC","AutoTestNotePaymentUniqueOTC","1 days","9876326526","generateuniquelink"
    Then Validation of Unique OTC Amount Field "AutoSME","PHP 50.00","AutoTestPaymentUniqueOTC"
